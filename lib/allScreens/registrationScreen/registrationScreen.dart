                ...
                children: [
                  ...
                  RaisedButton(
                    ...
                    onPressed: () async {
                      ...
                      ///phone Controller
                      else if (_phoneTextEditingController.text.trim().length !=
                          10) {
                        ErrorSnackBars.showFloatingSnackBar(
                            context: context,
                            defaultSize: defaultSize,
                      ...
                      ///User Creator function
                        ...
                        if (createdUser != null) {
                          ...
                          ErrorSnackBars.showFloatingSnackBar(
                              context: context,
                              defaultSize: defaultSize,
                              errorText: "Driver Created");
                          await CurrentUser.getCurrentUserInfo(context);
                          Navigator.pushNamedAndRemoveUntil(context,
                              CarInfoScreen.idScreen, (route) => false);
                        } else {
                          ErrorSnackBars.showFloatingSnackBar(
                              context: context,
                              defaultSize: defaultSize,
                              errorText: "Driver could not be created");
